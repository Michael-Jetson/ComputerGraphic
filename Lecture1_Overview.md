...
![Games101_L1_6](./assets/Games101_L1_6.png)
...
![Games101_L1_29](./assets/Games101_L1_29.png)
...
![Games101_L1_30](./assets/Games101_L1_30.png)

## 动画/仿真

![Games101_L1_31](./assets/Games101_L1_31.png)

## 与计算机视觉的区别

![Games101_L1_35](./assets/Games101_L1_35.png)
...
![Games101_L2_8](./assets/Games101_L2_8.png)

还有向量的运算，比如说几何角度下的平行四边形法则或者三角形法则，代数角度下的坐标数值相加

![Games101_L2_9](./assets/Games101_L2_9.png)

## 向量运算

### 点乘（Dot Product）

![Games101_L2_12](./assets/Games101_L2_12.png)
...
![Games101_L2_15](./assets/Games101_L2_15.png)

还可以计算两个向量的垂直或者投影，或者两个向量的方向多么接近，以及定义向量方向

![Games101_L2_17](./assets/Games101_L2_17.png)

### 叉乘（Cross Product）

代表了两个向量的有方向的面积，可以用来建立三维空间中的坐标系

![Games101_L2_20](./assets/Games101_L2_20.png)

![Games101_L2_21](./assets/Games101_L2_21.png)

在这里我们假定所有的都是右手坐标系，实际上OpenGL是右手系，Unity是左手系

图形学中叉乘的作用就是判断左和右，内和外（实际上这是一个概念）

![Games101_L2_24](./assets/Games101_L2_24.png)
...
![Games101_L2_27](./assets/Games101_L2_27.png)

### 矩阵乘法

可以用来做坐标变换操作

![Games101_L2_34](./assets/Games101_L2_34.png)

当然还可以使用矩阵表示叉乘运算

![Games101_L2_37](./assets/Games101_L2_37.png)